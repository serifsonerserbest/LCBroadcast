...
public class ApplicationSettings {
    ...
    public final int ListenerThreadPoolSize = (Runtime.getRuntime().availableProcessors() + 1) * 30;
    public final int SenderThreadPoolSize = (Runtime.getRuntime().availableProcessors() + 1) * 30;
